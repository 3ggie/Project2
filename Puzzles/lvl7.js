...
stage7.addChild(playSprite);
stage7.addChild(Menu);




function animatelvl7() {
	requestAnimationFrame(animatelvl7);
	renderer.render(stage7);
}
animatelvl7();
