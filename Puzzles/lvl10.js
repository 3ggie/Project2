...
var stage10 = new PIXI.Container();
...
stage10.addChild(playSprite);
stage10.addChild(Menu);




function animatelvl10() {
	requestAnimationFrame(animatelvl10);
	renderer.render(stage10);
}
animatelvl10();
